...
public class Token
{
    ...
    // start enum
        ...
        // Interpreter reuses the following as bytecodes（解释者重用一下字节码）
        ...
        SETELEM        = 37,
        CALL           = 38,
        NAME           = 39,	//变量名、函数名、对象名等（如document,getElementById,innerHTML），而js中的关键字不属于
        NUMBER         = 40,	//常量数字，如0
        STRING         = 41,	//双引号或单引号括起来的字符串
        NULL           = 42,
        THIS           = 43,
        FALSE          = 44,
        TRUE           = 45,
    ...
    public final static int
        ...
        LB             = 82,  // left and right brackets 左方括号和右方括号
        RB             = 83,
        LC             = 84,  // left and right curlies (braces)（左花括号和右花括号）
        RC             = 85,
        LP             = 86,  // left and right parentheses（左圆括号和右圆括号）
        RP             = 87,
        COMMA          = 88,  // comma operator（逗号）
    ...
    public final static int
        ...
        COLON          = 102,
        OR             = 103, // logical or (||) 逻辑或
        AND            = 104, // logical and (&&) 逻辑与
        INC            = 105, // increment/decrement (++ --) ++，--操作符
        DEC            = 106,
        DOT            = 107, // member operator (.)逗号操作符
        ...
        CONDCOMMENT    = 160,  // JScript conditional comment	JScript条件注释(即<!--  -->) 适用与IE
